    ...
    $(document).ready(function(){
        $("#occupations").on(
            "change",function () {
                ...
                $('.demo').empty();
                jQAJAX(getRootPath()+"/jsp/dataAction!occRloe", send, function (msg) {
                    ...
                    var demo2 = $('.demo').doublebox({
                        ...
                        moveOnSelect: false,
                        nonSelectedList:ob.loses,
                        selectedList:ob.haves,
                        optionValue:"menu_Id",
